...
static void CreateVertexBuffer()
{
	...
	Vertex Vertices[8] = {
		Vertex(Vector3f(-6.f, 1.f, 0.f), Vector2f(0.5f, 0.5f)),
		Vertex(Vector3f(-5.5f, 1.f, 0.f), Vector2f(0.5f, 0.f)),
		Vertex(Vector3f(-6.f, -1.f, 0.f), Vector2f(1.f, 0.f)),
		Vertex(Vector3f(-5.5f, -1.f, 0.f), Vector2f(0.5f, 1.f)),
		Vertex(Vector3f(6.f, 1.f, 0.f), Vector2f(0.5f, 0.5f)),
		Vertex(Vector3f(5.5f, 1.f, 0.f), Vector2f(0.5f, 0.f)),
		Vertex(Vector3f(6.f, -1.f, 0.f), Vector2f(1.f, 0.f)),
		Vertex(Vector3f(5.5f, -1.f, 0.f), Vector2f(0.5f, 1.f))
...
int main(int argc, char** argv)
{
	...
	glTexture = new Texture(GL_TEXTURE_2D, "../Content/white.png");
